...
class InvisibleTest {
    ...
    void onExecute() throws InstanceFaceOutOfBoundException {
        ...
        FaceSpecial f = FactoryFace.getInstance().getFaceSpecial(FaceSpecialEnum.FACE_MULTIPLE_3);
        cmd = new Invisible(manager,managerCmd,idPlayer);
        ...
        Assertions.assertEquals(FaceSpecialEnum.FACE_MULTIPLE_3,argument.getValue().faceEnum);
    }
